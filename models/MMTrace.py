...
class MMTrace(nn.Module):
    ...
    def forward(self, inputs_video, inputs_audio):
        ...
        # print(patches_video.shape)
        # patches_video = torch.reshape(patches_video, (patches_video.shape[0], -1, 384))
        patches_video = torch.reshape(patches_video, (patches_video.shape[0], 384, -1))
        patches_video = patches_video.transpose(1,2)
